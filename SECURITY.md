...
For `zillow-public-data`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit large generated `data/` or `viz/` outputs unless the publication plan is explicit and reviewed.
